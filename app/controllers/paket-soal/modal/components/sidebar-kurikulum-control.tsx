...
export default function SidebarKurikulumControl({
    ...
    const displayKurikulum = useMemo(()=>{
        return GroupedAtpHasManySOal.buildGroup(data)
    },[data])
    ...
    const koleksiSoal = useMemo(
        ()=>{
            ...
            return (currentData.data_soal && yetImplemented) ? [currentData.data_soal, ...yetImplemented]: yetImplemented;
        }, [itemAtpSelected, currentData.bentuk_soal?.name, currentData.data_soal, koleksiIdSoalHasImplemented])
