...
import {  SwitchModeTahunan, SwitchSabtuLibur } from "~/components/toolbars/state-toolbar/comp-switch";

export const ConfigToolbarKaldikHariEfektif:TabsConfigProps =  {
        defaultValue:"tab1",
        tabList:[
            {
                value: 'tab1',
