...
export default function FormInfoRiwayatAkun({dataAkun}:{dataAkun:IdAkunDanPangkat}){
    ...
    return (
        <>
            <div className="h-8/12 overflow-y-auto scrol-h-custom mx-5 border min-w-8/12 p-4 bg-sky-100 shadow-sm shadow-sky-400 rounded-2xl">
            ...
            <ModalFooterEdura>
                <ButtonDeleteAwesome className="py-0 px-4" labelButton="Kembali" onClick={actions.close}>
                    <MoveLeft size={12} className="self-center"/>
                </ButtonDeleteAwesome>
            </ModalFooterEdura>
        </>
    )
