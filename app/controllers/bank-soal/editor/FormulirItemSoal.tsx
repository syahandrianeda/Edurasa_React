...
import FieldJumlahOpsi from "../component-item-soal/field/FieldJumlahOpsi";
...
export default function FormulirItemSoal({description,bentukSoal}:{description:string,bentukSoal?:ListBentukSoalType}){
    ...
    return (
        <>
            ...
            <div className="relative w-11/12 mx-auto gap-0 bg-linear-to-br  from-sky-300 via-emerald-300 to-purple-300 shadow-md shadow-sky-600 rounded-2xl p-2 mb-3">
            ...
            <FieldsetOpsiJawaban/>
            <div className="relative w-11/12 mt-7 mx-auto gap-0 bg-linear-to-br  from-sky-300 via-emerald-300 to-purple-300 shadow-md shadow-sky-600 rounded-2xl p-2 mb-3">
                <div className="font-bold absolute -top-3 left-0 bg-sky-300 ps-1 pe-4 rounded-tr-2xl">
                    Pembahasan Soal:
                </div>
                <FieldInputPembahasan/>
