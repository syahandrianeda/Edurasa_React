...
export default function SppdResumePreview(){
    ...
    return (
        <div className="border p-4 flex flex-col gap-4 max-h-svh overflow-y-auto scrol-h-custom">
            <h3 className="font-bold uppercase text-center">Informasi SPPD</h3>
            <div className=" pt-4 md:w-10/12 w-full mx-auto">
                <TableWithScrolling inModal={true} className="border-none">
                    <tbody>
                        <tr>
