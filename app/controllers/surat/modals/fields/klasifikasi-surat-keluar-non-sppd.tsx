...
export default function KlasifikasiSuratNonSppd({prefix, onChangePrefix, setCurrentData}:KlasifikasiSuratProps){
        ...
        <>
            ...
            <div className="relative mt-5">
                ...
                <Select
                    ...
                    <SelectContent>
                        {
                            KlasifikasiNoSurat.filter(s=>s.template !=='SPPD').map(({ value, description },i) => 
