...
import EditPembahasanModal from '../edit-pembahasan-modal';
import EditMateriPokok from '../edit-materi-pokok';
...
type Props = {
    ...
    valueJsonPembahasan:JSONContent|null, 
    actionPembahasan:Dispatch<SetStateAction<JSONContent|null>>,
}
export default function ContentTabPembahasan({
    currentData,
    ...
    return (
            <div className='flex flex-col md:flex-row md:px-2 gap-1 mt-2 text-sm pb-2 overflow-y-auto scrol-h-custom'>
                <div className="md:w-72 hidden bg-sky-50 dark:bg-slate-400 shadow-lg shadow-sky-500 pt-2 border-sky-300 p-1 rounded-s-2xl gap-2 md:flex md:flex-col">
                ...
                <div className="md:flex-2 bg-sky-50 dark:bg-slate-400 shadow-lg shadow-sky-500 px-4 md:px-2 rounded-e-2xl min-h-94 pt-2 overflow-y-auto scrol-h-custom">
                    <EditMateriPokok/>
                    <EditPembahasanModal valueJson={valueJsonPembahasan}  action={actionPembahasan}/>
            </div>
        </div>
    )
}