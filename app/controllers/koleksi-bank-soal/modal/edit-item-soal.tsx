...
import SendEditSoal from './crud-buttons/send-edit-soal';
import SendCopySoal from './crud-buttons/send-copy-soal';
import { useCrudBankSoalProvider } from '~/controllers/bank-soal/cruds/crud-provider-bank-soal';

export default function ModalEditItemSoal(){
    /**source of truth */
        ...
        <FieldSet disabled={state.isSubmitting}>
            ...
            <ModalFooterEdura>
                <div className="w-full flex justify-center gap-x-2">
                    <SendCopySoal data={currentData}/>
                    <SendEditSoal data={currentData}/>
                </div>
            </ModalFooterEdura>
        </FieldSet>
    )
