...
const RefrenceKeyTable : KeyModelTable<SiswaType>[] = [
    ...
    {
        type: 'field',
        render: (row) => row.nama_rombel,
        className:'text-center',
        key: 'nama_rombel'
    },
    {
        type: 'field',
        render: (row) => getAgamaLabel(row.pd_agama),
        key: 'pd_agama'
    },
    {
        type: 'field',
        render: (row) => getGenderLabel(row.pd_jk),
        key: 'pd_jk'
    },
...
export function TableSiswaJenjangWithValidation({data}:{data:SiswaWithValidation[]}) {
    ...
    return (
        <TableWithScrolling>
            <HeadingTableWithSortValidation  dataHead={HeadingTable} data={data} dataKey={tableKeys}/>
        </TableWithScrolling>
    )
}