...
import validationAddPublikasi from "./validation-add-publikasi";


export default function  AddPublikasiPaketSoal(){
    ...
    const onSubmit = useCallback(()=>{
        const isValid = validationAddPublikasi(currentData);
        if(!isValid.isValid){
