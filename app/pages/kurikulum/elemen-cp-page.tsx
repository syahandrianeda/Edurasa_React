...
export default function ElemenCpPage(){
    ...
    const test = useAppSelector(KurmerDtoSelector);
    const st = useAppSelector(s=>s );
    // const sllState = useAppSelector(state=>state)
    // console.log('data PropertyKurikulum Mapel SElector', data);
    // console.log('Test dto cp', test);
    // console.log('state redux', st)
    // console.log('AllState', sllState);
    return (
        <div className="p-1">
