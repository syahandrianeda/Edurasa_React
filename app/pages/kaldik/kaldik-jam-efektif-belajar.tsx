...
export default function KaldikJamEfektifBelajar({semester}:{semester:number}){
    ...
    return (
        <div className="p-1">
            <h3 className="text-3xl text-center font-extrabold uppercase mb-0">Jumlah Jam Pelajaran Efektif</h3>
            <h3 className="text-2xl text-center font-extrabold uppercase mb-0">{IDENTITAS_SEKOLAH}</h3>
            {
                modePartSemester?(
                    <>
                            ...
                            <TableHariEfektif sizeNormal={true} dataTotal={totalPropertiHariBelajar3} caption="Jumlah Jam Pelajaran (1 hari @ 7 JP)" data={dataPropertiHari3} sabtuLibur={isSabtuLibur as boolean} isHeb={true} jp={7}/>
                    </>
                    ):(
                    <>
                        <h3 className="text-xl text-center font-extrabold mb-5">{currentTapel({variant:'full'})} Semester {semester}</h3>
                        <TableHariEfektif sizeNormal={true} dataTotal={totalPropertiHariBelajar} caption="Jumlah Jam Pelajaran (1 hari @ 7 JP)" data={dataPropertiHari} sabtuLibur={isSabtuLibur as boolean} isHeb={true} jp={7}/>
                    </>
                )
            }                       
