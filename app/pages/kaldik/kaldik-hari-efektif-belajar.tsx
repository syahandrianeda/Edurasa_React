...
export default function KaldikHariEfektifBelajar({semester}:{semester:number}){
    ...
    return (
        <div className="p-1">
            <h3 className="text-3xl text-center font-extrabold uppercase mb-0">Jumlah Hari Efektif Belajar</h3>
            <h3 className="text-2xl text-center font-extrabold uppercase mb-0">{IDENTITAS_SEKOLAH}</h3>
            {
                modePartSemester?(
                    <>
                            ...
                            <TableHariEfektif sizeNormal={true} dataTotal={totalPropertiHariBelajar3} caption="Jumlah Hari Efektif Belajar" data={dataPropertiHari3} sabtuLibur={isSabtuLibur as boolean} isHeb={true}/>
                    </>
                    ):(
                    <>
                        <h3 className="text-xl text-center font-extrabold mb-5">{currentTapel({variant:'full'})} Semester {semester}</h3>
                        <TableHariEfektif sizeNormal={true} dataTotal={totalPropertiHariBelajar} caption="Jumlah Hari Efektif Belajar" data={dataPropertiHari} sabtuLibur={isSabtuLibur as boolean} isHeb={true}/>
                    </>
                )
            }                       
