...
export default function ButtonSaveAwesome({labelButton, className, children, ...props}:ComponentProps<'button'> & {labelButton:string, children?:ReactNode}){
    return (
        <button
            type="button"
        ...
        >
            {
                children || <SaveAllIcon size={15} className="font-extrabold"/>
            }
