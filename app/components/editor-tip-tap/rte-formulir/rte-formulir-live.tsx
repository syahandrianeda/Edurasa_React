...
export default function RteTiptapFormulirLive({ value = "", onChange, valueJson, onChangeJson }: Props) {
    ...
    return (
        <div 
            ...
            className="border border-slate-400 bg-slate-300 rounded-md p-0 w-full">
            ...
            <div className="flex space-x-1 px-2 justify-center items-stretch">
                ...
                <GroupToolbar>
                    ...
                    <div className="border-t text-center">Lampiran</div>
                </GroupToolbar>
            </div> 
