import type { cellsTableKop, TableKop } from "~/export/word-edura/parser/common-comps/type-comp";
import { parseImageExcel } from "./parse-image-excel";

export default async function parseKopExcel(table:HTMLTableElement):Promise<TableKop>{
