...
export default function SubBankSoalLayout({matches}:Route.ComponentProps) {
    ...
    const result = PermissionFeature(user_permission ?? [], 'view bank soal', SubFiturBankSoal);
    ...
    return (
        <AppSidebar showExport={showExport} desktopHeader="relative" title={"Bank Soal - "+ titleTambahan} controlKelas={controlKelas}>
