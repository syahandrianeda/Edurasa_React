...
import { extractKelasKode, resolveAgama, resolveDate, resolveGender, resolveNumber, resolveString } from "./_resolver";
import { getNumberFromString } from "~/lib/get-number";



export class DTOSiswaFileDapodik {
    static fromApi(dto: Record<string, any>): SiswaTypeDapodik {
        return {
                index: resolveNumber(dto.index),
                id: resolveNumber(dto.id),
                jenjang: getNumberFromString(dto.nama_rombel)??dto.jenjang,
                ...
                pd_tanggallahir: resolveDate(dto.pd_tanggallahir) as Date,
    ...
    static fromApiArray(dto: Record<string, any>):SiswaTypeDapodik[]{
