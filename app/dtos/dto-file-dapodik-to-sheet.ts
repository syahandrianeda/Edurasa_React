//SiswaDapodikAppToSheet

import type { SiswaDapodikAppToSheet, SiswaTypeDapodik } from "~/types/siswa-dapodik";
import { extractKelasKode, resolveNumber, resolveString } from "./_resolver";
import { formatBackendISO } from "~/lib/date-helper";
import { Agama } from "~/types/enums/agama";
import { getEnumKey } from "~/lib/get-enum-key";
import { Gender } from "~/types/enums/gender";


export class DTOSiswaDapodikAppToSheet {
    static fromImport(dto: SiswaTypeDapodik): SiswaDapodikAppToSheet {
        return {
                ...
                pd_tanggallahir: formatBackendISO(dto.pd_tanggallahir),
                nik: resolveString(dto.nik),
                pd_agama:  getEnumKey(Agama, dto.pd_agama||''),
                ...
                dapo_jenjangpendidikanayah: resolveString(dto.dapo_jenjangpendidikanibu),
    ...
    static fromImportArray(dto: Record<string, any>):SiswaDapodikAppToSheet[]{
        
        return dto.map(this.fromImport);
