...
import KaldikHariEfektif from "~/pages/kaldik/kaldik-hari-efektif";
import type { Route } from "./+types/hari-efektif-semester-2";
...
export async function clientLoader({}:Route.ComponentProps){
    ...
    return {
        titleTambahan: 'Hari Efektif Semester 2', 
        data: [], // data: data, 
        toolbarTabs: ConfigToolbarKaldikHariEfektif,
        controlKelas: settingRombel,
        pesanLoading:'Mempersiapkan Hari Efektif Belajar semester 1',
        // addPesanRombel:{isAdd:true, type:'rombel', includeFaseName:false},
        sheetNeeded: [sheetKaldik_kalender]
    };
}

export default function KaldikHariEfektifSemesterDuaRoute({loaderData}: Route.ComponentProps){
    return (
        <KaldikHariEfektif semester={2}/>
    )
}