...
import type { Route } from "./+types/hari-efektif-semester-1";
...
export async function clientLoader({}:Route.ComponentProps){
    ...
    return {
        titleTambahan: 'Hari Efektif Semester 1', 
        data: [], // data: data, 
        toolbarTabs: ConfigToolbarKaldikHariEfektif,
        controlKelas: settingRombel,
        pesanLoading:'Mempersiapkan Hari Efektif semester 1',
        // addPesanRombel:{isAdd:true, type:'rombel', includeFaseName:false},
        sheetNeeded: [sheetKaldik_kalender]
    };
}

export default function KaldikHariEfektifSemesterSatuRoute({loaderData}: Route.ComponentProps){
    return (
        <KaldikHariEfektif semester={1}/>
    )
}