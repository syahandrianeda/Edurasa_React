...
import type { Route } from "./+types/jam-belajar-semester-1";
...
export async function clientLoader({}:Route.ComponentProps){
    ...
    return {
        titleTambahan: 'Jam Efektif Belajar Semester 1', 
        data: [], // data: data, 
        toolbarTabs: ConfigToolbarKaldikHariEfektif,
        controlKelas: settingRombel,
        pesanLoading:'Mempersiapkan Jam Efektif Belajar semester 1',
        // addPesanRombel:{isAdd:true, type:'rombel', includeFaseName:false},
        sheetNeeded: [sheetKaldik_kalender]
    };
}

export default function KaldikJamEfektifBelajarSemesterSatuRoute({loaderData}: Route.ComponentProps){
    return (
        <KaldikJamEfektifBelajar semester={1}/>
    )
}